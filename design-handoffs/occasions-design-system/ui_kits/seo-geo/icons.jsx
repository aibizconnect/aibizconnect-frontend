...
function SGIcon({ name, size = 20, strokeWidth = 2, color = 'currentColor', style, ...rest }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color}
      strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round"
      style={{ flex: 'none', ...style }}
      dangerouslySetInnerHTML={{ __html: SG_ICONS[name] || '' }} {...rest} />
  );
}

window.SGIcons = { Icon: SGIcon, ICON_NAMES: Object.keys(SG_ICONS) };
