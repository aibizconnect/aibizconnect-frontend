...
export const sectionFieldSpecs: Record<SectionType, FieldSpec[]> = {
  ...
  countdown: [
    ...
    { kind: "select", key: "units", label: "Precision", options: ["dhms", "hms", "ms"] },
    { kind: "select", key: "display", label: "Style", options: ["cells", "inline"] },
    ...
    { kind: "number", key: "size", label: "Digit size", min: 12, max: 120, step: 1, unit: "px" },
