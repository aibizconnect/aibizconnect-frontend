...
export const sectionFieldSpecs: Record<SectionType, FieldSpec[]> = {
  ...
  listings: [
    { kind: "text", key: "heading", label: "Heading" },
    {
      kind: "object", key: "filter", label: "Saved search (what to show)", fields: [
        { kind: "select", key: "propertyClass", label: "Property class", options: ["", "Residential", "Condo & Other", "Commercial"] },
        { kind: "select", key: "transactionType", label: "Sale / Lease", options: ["", "For Sale", "For Lease"] },
        { kind: "text", key: "city", label: "City / municipality" },
        { kind: "text", key: "community", label: "Community / neighbourhood" },
        { kind: "select", key: "propertyUse", label: "Commercial use", options: ["", "Retail", "Office", "Industrial", "Business", "Multi", "Hospitality", "Agriculture", "Land"] },
        { kind: "number", key: "minPrice", label: "Min price", min: 0, step: 50000 },
        { kind: "number", key: "maxPrice", label: "Max price", min: 0, step: 50000 },
        { kind: "number", key: "beds", label: "Min beds", min: 0, max: 10 },
        { kind: "number", key: "baths", label: "Min baths", min: 0, max: 10 },
        { kind: "number", key: "minSqft", label: "Min sq ft", min: 0, step: 100 },
      ],
    },
    { kind: "number", key: "count", label: "Listings per page", min: 1, max: 24 },
    { kind: "number", key: "columns", label: "Columns", min: 1, max: 4 },
    { kind: "select", key: "sort", label: "Default sort", options: ["newest", "price_asc", "price_desc"] },
    { kind: "boolean", key: "showSort", label: "Show sort dropdown" },
    { kind: "boolean", key: "showPagination", label: "Show pagination" },
    { kind: "boolean", key: "showFavorites", label: "Show ♡ favorites" },
    { kind: "boolean", key: "showBadges", label: "Show NEW badges" },
    { kind: "boolean", key: "showAttribution", label: "Show brokerage attribution" },
    { kind: "boolean", key: "showDisclaimer", label: "Show MLS disclaimer" },
    { kind: "text", key: "ctaLabel", label: "Button label (optional)" },
    { kind: "text", key: "ctaHref", label: "Button link (optional)" },
  ],
  "contact-form": [
    { kind: "text", key: "heading", label: "Heading" },
    { kind: "text", key: "subheading", label: "Subheading", multiline: true },
  ...
  countdown: [
    { kind: "text", key: "title", label: "Title" },
    { kind: "text", key: "preText", label: "Pre text" },
    { kind: "text", key: "postText", label: "Post text" },
    { kind: "text", key: "footer", label: "Footer" },
    { kind: "select", key: "mode", label: "Mode", options: ["counter", "timer", "date"] },
    // counter
    { kind: "number", key: "from", label: "From (counter)", step: 1 },
    { kind: "number", key: "to", label: "To (counter)", step: 1 },
    { kind: "number", key: "duration", label: "Duration (sec) — counter", min: 0.1, step: 0.5 },
    ...
    { kind: "select", key: "display", label: "Style — timer/date", options: ["cells", "inline"] },
    // styling
    { kind: "select", key: "align", label: "Justify", options: ["left", "center", "right"] },
    { kind: "color", key: "fgColor", label: "Digits color" },
    { kind: "color", key: "bgColor", label: "Background" },
    { kind: "number", key: "size", label: "Digit size", min: 12, max: 160, step: 1, unit: "px" },
    { kind: "text", key: "font", label: "Font family" },
  ],
